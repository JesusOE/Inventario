		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					Realizar la administración y supervisión de los usuarios con habilitación de acceso al sistema.
				</p>
			</div>
		</section>
								...
								<form action="php/insertar_usuario.php" method="post">
									<div class="mdl-grid">
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											<h5 class="text-condensedLight">Datos de administrador</h5>
										...
										<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
											<h5 class="text-condensedLight">Establecer contraseña</h5>
											<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
